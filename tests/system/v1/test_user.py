...
def test_user_register():
    ...
    user_data = {"username": f"example_user_{random_num}",
...
def test_user_login():
    response = client.post(f"{configs.api_version}/user/login",
...
def test_user_me():
    login_response = client.post(f"{configs.api_version}/user/login",
                                 data={"username": "example_user", "password": "example_password"})
