...
from src.main.system.factory.service_factory import get_user_service
...
async def readiness(user_id: int = 1, user_service: UserService = Depends(get_user_service)):
    """
