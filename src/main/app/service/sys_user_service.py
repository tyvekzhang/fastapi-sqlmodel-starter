...
from src.main.app.schema.sys_user_schema import UserQuery, UserDetail, UserCreate, LoginForm, UserPage
...
class UserService(BaseService[UserModel], ABC):
    ...
    @abstractmethod
    async def import_user(self, *, file: UploadFile, current_user: CurrentUser) -> List[UserCreate]:...